...
- ...:
  ...
  [Task](https://vitals.tidyverse.org/reference/Task.md)'s `$eval()`
  method as usual.)
...
of [Task](https://vitals.tidyverse.org/reference/Task.md)'s `$new()`
...
not in [Task](https://vitals.tidyverse.org/reference/Task.md)'s
