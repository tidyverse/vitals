...
the simplest possible solver, and
[scorer_model](https://vitals.tidyverse.org/reference/scorer_model.md)
and
[scorer_detect](https://vitals.tidyverse.org/reference/scorer_detect.md)
...
- `solver`:
  ...
  [`generate()`](https://vitals.tidyverse.org/reference/generate.md) for
  a function that outputs a valid solver that just passes inputs to
...
- `scorer`:
  ...
  scoring](https://vitals.tidyverse.org/reference/scorer_model.md) for
  examples.
