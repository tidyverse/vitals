...
- [`Task`](https://vitals.tidyverse.org/dev/reference/Task.md) :
...
- [`model_graded_qa()`](https://vitals.tidyverse.org/dev/reference/scorer_model.md)
  ...
  : Model-based scoring
- [`detect_includes()`](https://vitals.tidyverse.org/dev/reference/scorer_detect.md)
  ...
  [`detect_exact()`](https://vitals.tidyverse.org/dev/reference/scorer_detect.md)
  [`detect_answer()`](https://vitals.tidyverse.org/dev/reference/scorer_detect.md)
...
- [`are`](https://vitals.tidyverse.org/dev/reference/are.md) : An R Eval
