...
Combine multiple [Task](https://vitals.tidyverse.org/reference/Task.md)
objects into a single tibble for comparison.

This function takes multiple (optionally named)
[Task](https://vitals.tidyverse.org/reference/Task.md) objects and
